<div class="container-fluid"   
    ...
    <div class="alert alert-success" role="alert"><i class="fa fa-university"></i>&nbsp&nbspKONDITE</div>
    ...
    <div class="content">
            ...
            <td colspan="3" ><input style="float: right; width: 24%" type="number" name="poin" maxlength="3" size="3" value="<?php echo $jumlahnya ?>"></td>
